...
A sample configuration is provided [here](https://github.com/wavefrontHQ/wavefront-collector/tree/master/data/awscloudwatch-sample-configuration/awscloudwatch.conf).
